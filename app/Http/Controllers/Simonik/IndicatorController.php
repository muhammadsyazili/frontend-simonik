...
class IndicatorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('info_message', sprintf("%s, Silakan lanjut ke menu <a class=\"text-danger font-weight-bold\" href=\"%s\">Referensi - Indikator: Create</a>", $response->object()->message, route('simonik.indicators.paper-work.reference.create')));
