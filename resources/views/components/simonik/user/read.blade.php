                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('simonik.user.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Add User">Add User</a>
                                        ...
                                        <tbody id="myTable">
                                            @forelse ($response->object()->data->users as $user)
                                                <tr>
                                                    ...
                                                    <td class="text-center small">{{ $user->actived ? 'active' : 'default' }}</td>
