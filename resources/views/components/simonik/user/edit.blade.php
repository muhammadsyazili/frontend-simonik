        ...
        @else
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    <form action="{{ route('simonik.user.update', ['id' => $response->object()->data->user->id]) }}" method="post">
                        @method('put')
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="name" value="{{ $response->object()->data->user->name }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="nip" value="{{ $response->object()->data->user->nip }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="username" value="{{ $response->object()->data->user->username }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-sm" name="email" value="{{ $response->object()->data->user->email }}" required>
                                    </div>
                                </div>

                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        <label class="small" for="dropdown-1">Unit <span class="text-danger">*</span></label>
                                        <select class="form-control form-control-sm" id="dropdown-1" name="unit">
                                            @foreach ($response->object()->data->units as $unit)
                                                <option value="{{ $unit->slug }}" @if ($response->object()->data->user->unit_id === $unit->id) selected @endif>{{ $unit->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
