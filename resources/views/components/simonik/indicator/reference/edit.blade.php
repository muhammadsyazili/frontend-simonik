                                ...
                                @else
                                    ...
                                    @if ($level !== 'super-master')
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            <p class="text-center"><small><strong>Noted!</strong> Aksi ini akan mengubah referensi KPI di <strong>Level: {{ strtoupper(str_replace("-", " ", $level)) }} - Unit: @if ($unit === 'master'){{ 'SEMUA UNIT PADA LEVEL DIPILIH' }}@else{{ strtoupper(str_replace("-", " ", $unit)) }}@endif - Tahun: {{ strtoupper(str_replace("-", " ", $tahun)) }}</strong>.</small></p>
                                        </div>
                                    @endif
                                @endif
                            </div>
