                    ...
                    <form action="{{ route('simonik.indicators.store') }}" method="post">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <p class="text-center font-weight-bold small">Masa Berlaku <span
