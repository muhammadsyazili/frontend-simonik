                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <h5 class="text-center">Anda yakin ingin menghapus kertas kerja KPI <strong>Level: {{ strtoupper(str_replace("-", " ", $level)) }} - Unit: @if ($unit === 'master'){{ 'SEMUA UNIT PADA LEVEL DIPILIH' }}@else{{ strtoupper(str_replace("-", " ", $unit)) }}@endif - Tahun: {{ strtoupper(str_replace("-", " ", $tahun)) }}</strong> ?</h5>
