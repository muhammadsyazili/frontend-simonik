                            ...
                            @else
                                ...
                                <form action="{{ route('simonik.indicators.paper-work.update', ['level' => $level, 'unit' => $unit, 'tahun' => $tahun]) }}" method="post">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <p><small>- Aksi ini akan berkalu pada <strong>Level: {{ strtoupper(str_replace("-", " ", $level)) }} - Unit: @if ($unit === 'master'){{ "SEMUA UNIT PADA LEVEL DIPILIH" }}@else{{ strtoupper(str_replace("-", " ", $unit)) }}@endif - Tahun: {{ strtoupper(str_replace("-", " ", $tahun)) }}</strong>.</small></p>
                                    </div>
