        ...
        @else
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    <!-- card-header -->
                    <div class="card-header">
                        <h3 class="card-title">Kertas Kerja - KPI / Level : {{ request()->query('level') == null ? '-' : strtoupper(str_replace("-", " ", request()->query('level'))) }} / Unit : {{ request()->query('unit') == null ? '-' : strtoupper(str_replace("-", " ", request()->query('unit'))) }} / Tahun : {{ request()->query('tahun') == null ? '-' : strtoupper(str_replace("-", " ", request()->query('tahun'))) }}</h3>
                    </div>
                    <!-- end : card-header -->
