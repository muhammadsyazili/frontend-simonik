                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('simonik.level.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Add Level">Add Level</a>
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-bordered" id="drag-drop-table-sorting">
                                        ...
                                        <tbody id="myTable">
                                            @forelse ($response->object()->data->levels as $level)
                                                <tr>
