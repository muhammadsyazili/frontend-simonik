                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('simonik.unit.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Add Unit">Add Unit</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center small">
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route('simonik.unit.delete', ['id' => $unit->id]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @empty
