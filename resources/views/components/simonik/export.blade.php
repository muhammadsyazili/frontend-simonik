                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <form action="{{ route('simonik.export.index') }}" method="get">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                @else
                                    ...
                                    @else
                                        <a href="{{ route('simonik.export', ['level' => request()->query('level'),'unit' => request()->query('unit'),'tahun' => request()->query('tahun')]) }}" class="btn btn-info btn-block">Download</a>
                                    @endif
                                @endif
                            </div>
                        </div>
