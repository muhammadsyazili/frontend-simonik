...
@push('script')
    ...
    <script>
        ...
        function reducing_factor() {
            $('input[name="reducing_factor"]:checked').val() == 0 ? $("#polarity").show() : $("#polarity").hide();
        ...
        @else
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    <form action="{{ route('semongko.indicators.store') }}" method="post">
                        @method('post')
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                    <div class="form-group clearfix">
                                        <div class="d-inline">
                                            <input type="radio" name="type" value="KPI" checked>
                                            <label class="small">KPI</label>
                                        </div>
                                        <div class="d-inline">
                                            <input type="radio" name="type" value="PI">
