        ...
        @else
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    <form action="{{ route('semongko.indicators.paper-work.reference.store') }}" method="post">
                        @csrf
                        @method('post')
                                                ...
                                                <tbody class="small" id="myTable">
                                                    @foreach ($response->data->indicators as $indicator)
                                                        <tr style="background-color: rgb({{ $indicator->bg_color->r }}, {{ $indicator->bg_color->g }}, {{ $indicator->bg_color->b }}); @if (($indicator->bg_color->r < 127.5) && ($indicator->bg_color->g < 127.5) && ($indicator->bg_color->b < 127.5)) color: white; @endif">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group">
                                                                    <a href="{{ route('semongko.indicators.edit', ['id' => $indicator->id]) }}" class="btn btn-sm btn-outline-info" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
                                                                    <a href="{{ route('semongko.indicators.delete', ['id' => $indicator->id, 'name' => $indicator->indicator]) }}" class="btn btn-sm btn-outline-info" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                                </div>
