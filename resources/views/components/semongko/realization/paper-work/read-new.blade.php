        ...
        @else
                    ...
                    @if (in_array(request()->cookie('X-Role'), ['super-admin', 'admin']))
                        <div class="col-md-12">
                            <div class="card border-0 shadow rounded">
                                <!-- card-header -->
                                <div class="card-header">
                                    <h3 class="card-title">PENGISIAN REALISASI VIA EXCEL</h3>
                                </div>
                                <!-- end : card-header -->
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                            <a href="{{ route('semongko.realizations.paper-work.export', ['level' => request()->query('level'),'unit' => request()->query('unit'),'tahun' => request()->query('tahun')]) }}" class="btn btn-info btn-block" data-toggle="tooltip" data-placement="bottom" title="Download Template"><i class="fas fa-file-download"></i></a>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
                                            <form action="{{ route('semongko.realizations.paper-work.import', ['level' => request()->query('level'),'unit' => request()->query('unit'),'tahun' => request()->query('tahun')]) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                @method('post')
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <!-- card-header -->
                    <div class="card-header">
                        <h3 class="card-title">KERTAS KERJA - REALISASI / LEVEL : {{ cast_to_upper(request()->query('level'), '-') }} / UNIT KERJA : {{ cast_to_upper(request()->query('unit'), '-') }} / TAHUN : {{ cast_to_upper(request()->query('tahun'), '-') }}</h3>
                    </div>
                    <!-- end : card-header -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <form action="{{ route('semongko.realizations.paper-work.index') }}" method="get">
                                    <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                @else
                                    ...
                                    @else
                                        ...
                                        <form action="{{ route('semongko.realizations.paper-work.update') }}" method="post">
                                            @csrf
                                            @method('put')
