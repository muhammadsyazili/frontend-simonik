                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('semongko.unit.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Add">Add</a>

                                <input class="form-control form-control-sm mb-2" id="myInput" type="text" placeholder="Cari Unit Kerja..">
                                        ...
                                        <tbody class="small" id="myTable">
                                            @forelse ($response->data->units as $unit)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $unit->slug }}</td>
                                                    <td class="text-center">{{ $unit->parent_name }}</td>
                                                    <td class="text-center">{{ $unit->level_name }}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="{{ route('semongko.unit.edit', ['id' => $unit->id]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
                                                            <a href="{{ route('semongko.unit.delete', ['id' => $unit->id, 'name' => $unit->name]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @empty
