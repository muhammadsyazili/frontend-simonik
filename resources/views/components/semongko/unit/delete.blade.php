                    ...
                    <div class="card-footer clearfix">
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <a href="{{ route('semongko.unit.index') }}" class="btn btn-block btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="No">No</a>
                            </div>
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <form action="{{ route('semongko.unit.destroy', ['id' => $id]) }}" method="post">
                                    @csrf
                                    @method('delete')
