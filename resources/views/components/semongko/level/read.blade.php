                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('semongko.level.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Add">Add</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm" id="table">
                                        ...
                                        <tbody class="small" id="myTable">
                                            @forelse ($response->data->levels as $level)
                                                <tr>
                                                    <td class="text-center">{{ $loop->iteration }}</td>
                                                    <td class="text-center">{{ $level->name }}</td>
                                                    <td class="text-center">{{ $level->slug }}</td>
                                                    <td class="text-center">{{ $level->parent_name }}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            @if ($level->edit_modificable)
                                                                <a href="{{ route('semongko.level.edit', ['id' => $level->id]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
                                                            @endif
                                                            @if ($level->delete_modificable)
                                                                <a href="{{ route('semongko.level.delete', ['id' => $level->id, 'name' => $level->name]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
