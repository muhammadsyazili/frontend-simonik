                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                ...
                                <h5 class="text-center">Anda yakin ingin menghapus <strong>User: <span>@</span>{{ $username }}</strong>?</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer clearfix">
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <a href="{{ route('semongko.user.index') }}" class="btn btn-block btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="No">No</a>
                            </div>
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <form action="{{ route('semongko.user.destroy', ['id' => $id]) }}" method="post">
                                    @csrf
                                    @method('delete')
