        ...
        @else
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    <form action="{{ route('semongko.user.update', ['id' => $response->data->user->id]) }}" method="post">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="nama" value="{{ $response->data->user->name }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="nip" value="{{ $response->data->user->nip }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="username" value="{{ $response->data->user->username }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-sm" name="email" value="{{ $response->data->user->email }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="dropdown-1" name="unit_kerja">
                                            @foreach ($response->data->units as $unit)
                                                <option value="{{ $unit->slug }}" {{ $response->data->user->unit_id !== $unit->id ? '' : 'selected' }}>{{ $unit->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
