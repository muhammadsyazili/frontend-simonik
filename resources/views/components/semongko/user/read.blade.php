                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <a href="{{ route('semongko.user.create') }}" class="btn btn-info btn-sm mb-3" data-toggle="tooltip" data-placement="bottom" title="Create">Create</a>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group mb-1">
                                                            @if ($user->edit_modificable)
                                                                <a href="{{ route('semongko.user.edit', ['id' => $user->id]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit"></i></a>
                                                            @endif
                                                            @if ($user->delete_modificable)
                                                                <a href="{{ route('semongko.user.delete', ['id' => $user->id, 'username' => $user->username]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                            @endif
                                                            <a href="{{ route('semongko.user.password.reset.form', ['id' => $user->id, 'username' => $user->username]) }}" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Reset Password"><i class="fa fa-key" aria-hidden="true"></i></i></a>
                                                        </div>
