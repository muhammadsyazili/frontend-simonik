...
@section('content')
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('icon-brand-without-text.png') }}" alt="icon-brand-without-text" width="30%">
        </div>
        ...
        <div class="text-center font-weight-bold">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="form-group row" data-intro="Isi <strong>Username</strong>">
                    <label for="username"
                ...
                <div class="form-group row" data-intro="Isi <strong>Password</strong>">
                    <label for="password"
