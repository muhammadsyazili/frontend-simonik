...
<div class="login-box">
    <div class="login-logo">
        <img src="{{ asset('brand-icon.png') }}" alt="brand-icon" width="30%">
    </div>
    ...
    <div class="text-center font-weight-bold">
        ...
        @if (session()->has('danger_message'))
            <div class="alert alert-danger alert-dismissible">
                ...
                <h5 class="text-left"><i class="icon fas fa-ban"></i> {{ session()->get('danger_message') }}</h5>
            </div>
        @endif
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="form-group row">
                <label for="username" class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 col-form-label text-left">Username</label>
            ...
            <div class="form-group row">
                <label for="password" class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 col-form-label text-left">Password</label>
                <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
